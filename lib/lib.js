    ...
    (function (e, r) {
      ...
      (ie.prototype.clear = function () {
        ...
        (ie.prototype.set = function (e, t) {
          return (
            (this.__data__[e] =
              Q && void 0 === t ? "__lodash_hash_undefined__" : t),
            this
          );
        }),
      ...
      var pe,
        ...
        me =
          ...
          function (e, t) {
            ...
            for (
              var r = e.length, n = he ? r : -1, a = Object(e);
      ...
      function be(e, t) {
        for (
          var r = 0, n = (t = Ee(t, e) ? [t] : Se(t)).length;
          null != e && r < n;
            ...
            : (function (e, t, r, u, c, s) {
                ...
                return (
                  ...
                  (function (e, t, r, n, a, o) {
                    ...
                    for (; l--; ) {
                      var f = u[l];
                      if (!(i ? f in t : R.call(t, f))) return !1;
                    }
                    var d = o.get(e);
                    ...
                    for (; ++l < c; ) {
                      ...
                      var m = e[f],
                        y = t[f];
                      if (n)
                        var b = i ? n(y, m, f, t, e, o) : n(m, y, f, e, t, o);
      ...
      function we(e) {
        if (
          ((r = (t = e) && t.constructor),
          (n = ("function" == typeof r && r.prototype) || P),
          t !== n)
        )
          return U(e);
        var t,
        ...
        for (var o in Object(e))
          R.call(e, o) && "constructor" != o && a.push(o);
        return a;
      }
      function Se(e) {
        return Re(e) ? e : Ae(e);
      ...
      function Ke(e) {
        return (
          "symbol" == typeof e || (Ve(e) && "[object Symbol]" == z.call(e))
        );
      }
      var Ue = w
        ? (function (e) {
    ...
    var P = function e(t, r, n, a, i, u, s, l, f, d, p, h, m, y) {
        ...
        n && (_ = this.filterRegions(n, _)),
          ...
          (this.hiddenAreaCodes = this.excludeCountries(
            this.getFilteredCountryList(a, w),
            u
          ));
      },
      F = (function (e) {
        function t(e) {
          ...
          c(this, t),
            ((r = (function (e, t) {
              return !t || ("object" !== f(t) && "function" != typeof t)
                ? d(e)
                : t;
            })(this, p(t).call(this, e))).getProbableCandidate = C()(function (
              e
            ) {
              return e && 0 !== e.length
              ...
              if (e) {
                ...
                if (n && document.body) {
                  var a = n.offsetHeight,
                    ...
                    d = l - o + n.scrollTop,
                    p = a / 2 - s / 2;
                  if (r.props.enableSearch ? l < o + 32 : l < o)
                    t && (d -= p), (n.scrollTop = d);
                  else if (f > i) {
                    t && (d += p);
                    var h = a - s;
            ...
            (r.handleFlagDropdownClick = function (e) {
              if (
                (e.preventDefault(), r.state.showDropdown || !r.props.disabled)
              ) {
                var t = r.state,
            ...
            (r.handleInput = function (e) {
              ...
              if (t !== r.state.formattedNumber) {
                ...
                if ((o && e.persist(), t.length > 0)) {
                  var m = t.replace(/\D/g, "");
                  (!r.state.freezeSelection || p.dialCode.length > m.length) &&
                    ((u = r.props.disableCountryGuess
                      ? p
                      : r.guessSelectedCountry(m.substring(0, 6), l, d, h) ||
                        p),
                    (c = !1)),
                  ...
                  function () {
                    g > 0 && (y -= g),
                      ")" == i.charAt(i.length - 1)
                        ...
                        : y > 0 &&
                          b.length >= i.length &&
                          r.numberInputRef.setSelectionRange(y, y),
                      o &&
                        o(i.replace(/[^0-9]+/g, ""), r.getCountryData(), e, i);
                  }
                );
              }
            }),
            ...
            (r.handleFlagItemClick = function (e, t) {
              ...
              if (a) {
                var o = r.state.formattedNumber
                  ...
                  i =
                    o.length > 1
                      ? o.replace(n.dialCode, a.dialCode)
                      : a.dialCode,
            ...
            (r.handleInputBlur = function (e) {
              e.target.value ||
                r.setState({ placeholder: r.props.placeholder, searchValue: '' }),
                ...
                switch (e.which) {
                  ...
                  case t.ENTER:
                    r.props.enableSearch
                      ...
                      : r.handleFlagItemClick(
                          [].concat(
                            o(r.state.preferredCountries),
                            o(r.state.onlyCountries)
                          )[r.state.highlightCountryIndex],
                          e
                        );
                    break;
                  ...
                  default:
                    ((e.which >= t.A && e.which <= t.Z) ||
                      ...
                      r.setState(
                        {
                          queryString:
                            r.state.queryString + String.fromCharCode(e.which),
                        },
                ...
                var s = u.filter(function (e) {
                  ...
                  l = u.filter(function (e) {
                    var t = e.name,
                      r = e.localName;
                    e.iso2;
                    return ["".concat(t), "".concat(r || "")].some(function (
                      e
                    ) {
                      return e.toLowerCase().includes(c);
                    });
            ...
            (r.getCountryDropdownList = function () {
              var e,
                ...
                _ = y.a.createElement("li", {
                  key: "dashes",
                  className: "divider",
                });
              a.length > 0 &&
                (!d || (d && !u.trim())) &&
                C.splice(a.length, 0, _);
              var w = N()(
              ...
              return y.a.createElement(
                ...
                d &&
                  y.a.createElement(
                    "li",
                    { className: N()(n({ search: !0 }, m, m)) },
                    !h &&
                      y.a.createElement(
                        "span",
                        {
                          className: N()(
                            n({ "search-emoji": !0 }, "".concat(m, "-emoji"), m)
                          ),
                          role: "img",
          ...
          s = e.disableInitialCountryGuess
            ? 0
            : v.length > 1
            ? r.guessSelectedCountry(v.substring(0, 6), e.country, h, b) || 0
            : (e.country &&
                h.find(function (t) {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var c,
                  s,
                  l = e.replace(/\D/g, "");
                if (n && j()(e, u + n.dialCode))
                  (s = this.formatNumber(l, n)),
                    this.setState({ formattedNumber: s });
                else {
                  var f =
                    (c = this.props.disableCountryGuess
                      ? n
                      : this.guessSelectedCountry(l.substring(0, 6), i, r, a) ||
                        n) && j()(l, u + c.dialCode)
                      ? c.dialCode
                      : "";
                  (s = this.formatNumber(
            ...
            },
            {
              ...
              value: function () {
                ...
                var _ = N()(
                  ...
                  w = N()({ arrow: !0, up: l }),
                  S = N()(
                    (n((t = {}), this.props.inputClass, !0),
                    n(t, "form-control", !0),
                    n(t, "invalid-number", !a),
                    n(t, "open", l),
                    t)
                  ),
                  j = N()({ "selected-flag": !0, open: l }),
                  x = N()(
                    (n((r = {}), this.props.buttonClass, !0),
                    n(r, "flag-dropdown", !0),
                    n(r, "invalid-number", !a),
                    n(r, "open", l),
                    r)
                  ),
                  O = "flag ".concat(s && s.iso2);
                return y.a.createElement(
                  "div",
                  {
                    className: _,
                  ...
                  v &&
                    y.a.createElement("div", { className: "special-label" }, v),
                  o &&
                    y.a.createElement(
                      "div",
                  ...
                  y.a.createElement(
                    ...
                    m
                      ? y.a.createElement("div", { className: j }, m)
                      : y.a.createElement(
                          "div",
                          {
                            ...
                            className: j,
                            title: s
                              ? "".concat(s.name, ": + ").concat(s.dialCode)
                              : "",
                            tabIndex: h ? "-1" : "0",
                            role: "button",
                          ...
                          y.a.createElement(
                            "div",
                            { className: O },
                            !h && y.a.createElement("div", { className: w })
                          )
                        ),
